...
class StaticURLTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.post = Post.objects.create(
            text='Кем-то написанный какой-то текст',
    ...
    def test_unauthorized_user_urls_status_code(self):
        '''Проверка статусов для неавторизованного пользователя.'''
        field_urls_code = {
    ...
    def test_authorized_user_urls_status_code(self):
        '''Проверка статусов для авторизированного пользователя.'''
        field_urls_code = {
            reverse('posts:index'): HTTPStatus.OK,
            reverse(
                'posts:group_list', kwargs={'slug': self.group.slug}
    ...
    def test_author_user_urls_status_code(self):
        '''Проверка статусов для авторизированного автора.'''
        field_urls_code = {
            reverse('posts:index'): HTTPStatus.OK,
            reverse(
                'posts:group_list', kwargs={'slug': self.group.slug}
    ...
    def test_urls_uses_correct_template(self):
        '''Проверка правильности использования шаблонов URL-адресами'''
        templates_url_names = {
